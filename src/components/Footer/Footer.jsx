    ...
    <footer className={css.footer}>
      <div className={css.container}>
        <ul className={css.links_list}>
          <li className={css.links_list__item}><a href='https://github.com/Zamdikhanov' target='_blank' rel="noreferrer"><LogoGithubSVG className={css.logo} /></a></li>
          <li className={css.links_list__item}><a href='https://vk.com/zamdikhanov' target='_blank' rel="noreferrer"><LogoVkSVG className={css.logo} /></a></li>
        </ul>
