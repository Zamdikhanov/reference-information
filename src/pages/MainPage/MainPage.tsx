    ...
    <main>
      ...
      <div className={css.wrap}>
        ...
        <div className={css.news_container}>
          ...
          <p className={css.news__text}>Реализовано: создана главная страница и страница ошибки 404.</p>
          <p className={css.news__text}>Реализовано: Карточки светильников. Частично созданы данные и перенесены на mockapi.io. Данные загружаются с бэкэнда.</p>
          <p className={css.news__text}>В планах: создать страницы со списком карточек для всех сущностей. 
            ...
            Добавить страницы подробной информации каждого элемента.</p>
        </div>
      </div>
    </main>
  );
